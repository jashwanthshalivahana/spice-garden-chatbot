...
An AI-powered chatbot for **Spice Garden Restaurant, Hyderabad** — built with **Flask** and **Groq API**. Answers questions about the menu, timings, location, and handles reservations instantly. it is live @ https://steve161208.pythonanywhere.com/
